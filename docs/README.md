...
- `/Users/iwanteague/Desktop/Rustyfin/docs/reports/2026-04-02-first-install-dependency-audit-follow-up.md`
  - focused follow-up notes from the first-install dependency/layout examination, including the remaining installer reliability gaps
...
- `/Users/iwanteague/Desktop/Rustyfin/docs/reports/2026-04-03-ai-conversation-memory-research-and-implementation.md`
  - research-backed design note for persisted `/ai` conversation memory, prompt compaction, and runtime prompt telemetry
- `/Users/iwanteague/Desktop/Rustyfin/docs/reports/2026-04-03-ai-phase1-hardening-upgrade-note.md`
  - upgrade note for planner validation, turn journals, compact boundaries, prompt budgets, and generated-document verification
