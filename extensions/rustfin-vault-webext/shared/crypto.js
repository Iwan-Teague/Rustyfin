...
export async function unlockVault(masterPassword, userId, wrappedKey) {
...
export async function decryptVaultSummary(unlocked, item) {
...
export async function decryptVaultItem(unlocked, item) {
  const plaintext = await crypto.subtle.decrypt(
    {
      name: 'AES-GCM',
...
export async function encryptLoginItem(unlocked, item, matchMode) {
  const summary = {
