...
- AI
  ...
  - `/api/v1/ai/chat` now returns deterministic server-authored answers for explicit current-date/current-time questions through a host-local `system_get_current_datetime` tool, and corrective follow-ups like `Surely it would be the 7th` stay anchored to the active date question
