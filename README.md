...
- AI
  ...
  - The `/ai` `Instant` and `Thinking` toggle now flows through the backend request path: `instant` biases toward shorter, faster final answers, while `thinking` allows slower, more deliberate grounded responses without exposing hidden chain-of-thought
