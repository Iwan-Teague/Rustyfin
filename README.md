...
- AI
  ...
  - Human Dictionary reads now support account identity lookup, visible people search within a workspace, person bundle fetches, and relationship-relative reads such as birthdays, hobbies, and coworker/family listings from linked account context
