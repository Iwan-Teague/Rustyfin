...
use super::youtube::{
    YOUTUBE_LOOKUP_MAX_IDS, extract_youtube_video_id_from_input, fetch_youtube_video_metadata,
...
pub use super::youtube::YouTubeSearchResult;
...
pub async fn create_room(
    ...
    let (
        ...
        Option<String>,
        Option<String>,
    ) = if requested_mode.as_deref() == Some("play") {
        (
            "play".to_string(),
            "library".to_string(),
            None,
    ...
    } else if requested_mode.as_deref() == Some("create") {
